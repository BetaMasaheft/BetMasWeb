...
(:~
 ...
 :)
declare %templates:default("context", "$apprest:collection-rootMS") function apprest:origPlace($context as xs:string*) {
	let $cont := util:eval($context)
	let $scripts := config:distinct-values($cont//t:origPlace/t:placeName/@ref)
	return apprest:formcontrol("Place of origin", "origPlace", $scripts, "false", "rels", $context)
};

(:~
 : called by restSearch:FormPart() in search.xql used by advances search form as.html and filters.js MANUSCRIPTS FILTERS for CONTEXT
 :)
declare %templates:default("context", "$apprest:collection-rootMS") function apprest:scripts($context as xs:string*) {
	let $cont := util:eval($context)
	let $scripts := config:distinct-values($cont//@script)
	return apprest:formcontrol("Script", "script", $scripts, "false", "values", $context)
};

(:~
 : called by restSearch:FormPart() in search.xql used by advances search form as.html and filters.js
 :)
declare %templates:default("context", "$apprest:collection-rootMS") function apprest:support($context as xs:string*) {
	let $cont := util:eval($context)
	let $forms := config:distinct-values($cont//@form)
	return apprest:formcontrol("Object Type", "objectType", $forms, "false", "values", $context)
};

(:~
 : called by restSearch:FormPart() in search.xql used by advances search form as.html and filters.js
 :)
declare %templates:default("context", "$apprest:collection-rootMS") function apprest:material($context as xs:string*) {
	let $cont := util:eval($context)
	let $materials := config:distinct-values($cont//t:support/t:material/@key)
	return apprest:formcontrol("Material", "material", $materials, "false", "values", $context)
};

(:~
 : called by restSearch:FormPart() in search.xql used by advances search form as.html and filters.js
 :)
declare %templates:default("context", "$apprest:collection-rootMS") function apprest:bmaterial($context as xs:string*) {
	let $cont := util:eval($context)
	let $bmaterials := config:distinct-values($cont//t:decoNote[@type eq "bindingMaterial"]/t:material/@key)
	return apprest:formcontrol("Binding Material", "bmaterial", $bmaterials, "false", "values", $context)
};

declare %templates:default("context", "$apprest:collection-rootMS") function apprest:bindingtype(
	$context as xs:string*
) {
	let $cont := util:eval($context)
	let $bindingtype := config:distinct-values($cont//t:binding/@contemporary)
	return apprest:formcontrol("Original binding", "bindingtype", $bindingtype, "false", "values", $context)
};
...
(:~
 ...
 :)
declare %templates:default("context", "$apprest:collection-rootPlIn") function apprest:placeType(
	$context as xs:string*
) {
	let $cont := util:eval($context)
	let $placeTypes := config:distinct-values($cont//t:place/@type/tokenize(., "\s+"))
	return apprest:formcontrol("Place Type", "placeType", $placeTypes, "false", "values", $context)
};

(:~
 : called by restSearch:FormPart() in search.xql used by advances search form as.html and filters.js
 :)
declare %templates:default("context", "$apprest:collection-rootPr") function apprest:personType(
	$context as xs:string*
) {
	let $cont := util:eval($context)
	let $persTypes := config:distinct-values($cont//t:person//t:occupation/@type/tokenize(., "\s+"))
	return apprest:formcontrol("Person Type", "persType", $persTypes, "false", "values", $context)
};

(:~
 : called by restSearch:FormPart() in search.xql used by advances search form as.html and filters.js
 :)
declare %templates:default("context", "$exptit:col") function apprest:relationType($node as node(), $model as map(*)) {
	let $cont := util:eval($context)
	let $relTypes := config:distinct-values($cont//t:relation/@name/tokenize(., "\s+"))
	return apprest:formcontrol("Relation Type", "relType", $relTypes, "false", "values", $context)
};

(:~
 : called by restSearch:FormPart() in search.xql used by advances search form as.html and filters.js
 :)
declare %templates:default("context", "$apprest:collection-rootMS") function apprest:languages($context as xs:string*) {
	let $cont := util:eval($context)
	let $keywords := config:distinct-values($cont//t:language/@ident)
	return apprest:formcontrol("Language", "language", $keywords, "false", "values", $context)
};

(:~
 : called by restSearch:FormPart() in search.xql used by advances search form as.html and filters.js
 :)
declare %templates:default("context", "$apprest:collection-rootMS") function apprest:scribes($context as xs:string*) {
	let $cont := util:eval($context)
	...
	return apprest:formcontrol("Scribe", "scribe", $keywords, "false", "rels", $context)
};

(:~
 : called by restSearch:FormPart() in search.xql used by advances search form as.html and filters.js
 :)
declare %templates:default("context", "$apprest:collection-rootMS") function apprest:donors($context as xs:string*) {
	let $cont := util:eval($context)
	let $elements := $cont//t:persName[@role eq "donor"][not(@ref eq "PRS00000")][not(@ref eq "PRS0000")]
	let $keywords := config:distinct-values($elements/@ref)
	return apprest:formcontrol("Donor", "donor", $keywords, "false", "rels", $context)
};

(:~
 : called by restSearch:FormPart() in search.xql used by advances search form as.html and filters.js
 :)
declare %templates:default("context", "$apprest:collection-rootMS") function apprest:patrons($context as xs:string*) {
	let $cont := util:eval($context)
...
(:~
 : called by restSearch:FormPart() in search.xql used by advances search form as.html and filters.js
 :)
declare %templates:default("context", "$apprest:collection-rootMS") function apprest:owners($context as xs:string*) {
	let $cont := util:eval($context)
...
(:~
 : called by restSearch:FormPart() in search.xql used by advances search form as.html and filters.js
 :)
declare %templates:default("context", "$apprest:collection-rootMS") function apprest:binders($context as xs:string*) {
	let $cont := util:eval($context)
	let $elements := $cont//t:persName[@role eq "binder"][not(@ref eq "PRS00000")][not(@ref eq "PRS0000")]
	let $keywords := config:distinct-values($elements/@ref)
	return apprest:formcontrol("Binder", "binder", $keywords, "false", "rels", $context)
};

(:~
 : called by restSearch:FormPart() in search.xql used by advances search form as.html and filters.js
 :)
declare %templates:default("context", "$apprest:collection-rootMS") function apprest:parmakers($context as xs:string*) {
	let $cont := util:eval($context)
	let $elements := $cont//t:persName[@role eq "parchmentMaker"][not(@ref eq "PRS00000")][not(@ref eq "PRS0000")]
	let $keywords := config:distinct-values($elements/@ref)
	return apprest:formcontrol("Parchment Maker", "parchmentMaker", $keywords, "false", "rels", $context)
};

(:~
 : called by restSearch:FormPart() in search.xql used by advances search form as.html and filters.js
 :)
declare %templates:default("context", "$apprest:collection-rootMS") function apprest:contents($context as xs:string*) {
	let $cont := util:eval($context)
	let $elements := $cont//t:msItem
	let $titles := $elements/t:title/@ref
	let $keywords := config:distinct-values($titles)
	return apprest:formcontrol("Contents", "contents", $keywords, "false", "rels", $context)
};

(:~
 : called by restSearch:FormPart() in search.xql used by advances search form as.html and filters.js
 :)
declare %templates:default("context", "$apprest:collection-rootW") function apprest:WorkAuthors(
	$context as xs:string*
) {
	...
	return apprest:formcontrol("Authors", "authors", $keywords, "false", "rels", $context)
};

(:~
 : called by restSearch:FormPart() in search.xql used by advances search form as.html and filters.js
 :)
declare %templates:default("context", "$apprest:collection-rootIn") function apprest:tabots($context as xs:string*) {
	let $cont := util:eval($context)
	...
	return apprest:formcontrol("Tabot", "tabot", $alltabots, "false", "rels", $context)
};
	...
	<ul class="nodot">
		{
			...
			return <li>
				{
					if (starts-with($id/text(), "sdc:")) then
						"La Synthaxe du Codex " || substring-after($id/text(), "sdc:")

					else if (starts-with($id/text(), "urn:")) then
						<a href="{ $config:appUrl }/{ encode-for-uri($id/text()) }" target="_blank">{ $id/text() }</a>
					else if (contains($link, "betamasaheft")) then
						<a href="{ apprest:decidelink($id) }" target="_blank">{ exptit:printTitle($id/text()) }</a>
					else
						<a href="{ apprest:decidelink($id) }" target="_blank">{ $link }</a>
				}
			</li>
		}
	</ul>
...
declare function apprest:EntityRelsTable($this, $collection) {
	...
	return (
		...
		<div style="word-break:break-all;">
			<table xmlns="http://www.w3.org/1999/xhtml" class="w3-table-all w3-small">
				<thead><tr><th>Subject</th><th>Relation</th><th>Object</th><th>Description</th></tr></thead>
				<tbody>
					{
							...
							<td>
								{
									...
									return apprest:deciderelation($list//id)
								}
							</td>
							<td><a href="{ apprest:decidelink(data($relation/@name)) }">{ data($relation/@name) }</a></td>
							<td>
								{
...
declare function apprest:ModalRefsList($id, $string as xs:string, $sameKey) {
	let $value := if (doc($config:data-rootA || "/taxonomy.xml")//t:catDesc[text() eq $string]) then
		$exptit:col/id($string)//t:titleStmt/t:title/text()
	else if (matches($string, "gn:")) then
		exptit:getGeoNames($string)
	else if (matches($string, "(LOC|INS)(\d+)(\w+)")) then
		try { exptit:printTitle($apprest:collection-rootPlIn/id($string)//t:place) } catch * { "no record" }
	else
		$string
	return <div class="row-fluid">
		<h4>The following { count($sameKey) } entities also share the <a
				href="{
					if (matches($string, "gn:")) then (
						"http://www.geonames.org/" || substring-after($string, "gn:")
					) else
						concat($config:appUrl, "/", $string)
				}"
			>{ $value }</a> tag </h4>
		<div id="Samekeyword{ $string }">
			<ul>
				{
					if (matches($string, "(\w{3})(\d+)(\w+)")) then
						apprest:referencesList($id, $sameKey, "link")
					else
...
declare function apprest:referencesList($id, $list, $mode as xs:string) {
	...
	order by $stringid
	return <li xmlns="http://www.w3.org/1999/xhtml" class="nodot">
		{
			if ($strid = $id) then (
				"here"
			) else
				<a href="{ concat("/", $stringid) }">{ exptit:printTitleID($stringid) }</a>
		} ({ $stringid })
   <ul class="nodot">
			{
				for $h in $hit
				...
				group by $name := $n
				order by $name
				return <li class="nodot">a <code xmlns="http://www.w3.org/1999/xhtml">{ $name }</code> element {
						count($h)
					} time{
						if (count($h) > 1) then
							"s"
					...
					}
					{
						let $ids :=
							for $each in $h
							return if ($h/ancestor::t:item/@xml:id) then
								data($h/ancestor::t:item/@xml:id)
							else if ($h/ancestor::t:msPart/@xml:id) then
								data($h/ancestor::t:msPart/@xml:id)
							else (
							)
...
declare function apprest:institutions() {
	<form action="" class="form form-horizontal">
		<div class="w3-container">
			...
			<a class="w3-button w3-button-secondary" id="loadrepositories" role="button">load</a>
			<div class="input-group">
				<select class="w3-select w3-border" id="GoToRepo" />
				<div class="input-group-w3-button">
					<button class="w3-button w3-red" disabled="disabled" id="clickandgotoRepoID">Go</button>
				</div>
			</div>
		</div>
	</form>
...
declare function apprest:catalogues() {
	<form action="" class="form form-horizontal">
		<div class="w3-container">
			...
			<a class="w3-button w3-button-secondary" id="loadcatalogues" role="button">load</a>
			<div class="input-group">
				<select class="w3-select w3-border" id="GoToCatalogue" />
				<div class="input-group-w3-button">
					<button class="w3-button w3-red" disabled="disabled" id="clickandgotoCatalogueID">Go</button>
				</div>
			</div>
		</div>
...
declare function apprest:namedentitiescorresps($this, $collection) {
	...
	return let $refs :=
			...
			return if ($r/@ref = " " or $r/@ref = "") then (
				<ref>no valid id</ref>
			) else if ($r[name() eq "relation"]) then
				<ref ref="{ $r/@passive }" />
			else
				<ref
					ref="{
						if (contains($r/@ref, "#")) then
							substring-before($r/@ref, "#")
						else
							string($r/@ref)
					}" />
		let $corresps :=
			...
			return <ref
				ref="{
					if (contains($r/@corresp, "#")) then
						substring-before($r/@corresp, "#")
					else
						string($r/@corresp)
				}" />
		let $all := ($refs/@ref, $corresps/@ref)
		for $namedEntity in config:distinct-values($all)
		return <div class="hidden" id="{ $namedEntity }relations-all">
			<div id="{ $namedEntity }relations-content">{ apprest:AnyReferences($id, $namedEntity) }</div>
		</div>
};
...
declare function apprest:AnyReferences($sourceid, $id as xs:string) {
	...
	return <ul xmlns="http://www.w3.org/1999/xhtml" class="nodot">
		<head xmlns="http://www.w3.org/1999/xhtml">This record, with ID: { string($id) } is mentioned by </head>
...
declare function apprest:WhatPointsHereQuery($id as xs:string) {
	for $corr in
		(
			$exptit:col//t:*[ft:query(@corresp, $id)],
...
declare function apprest:WhatPointsHere($id as xs:string, $c) {
	...
	let $allrefs := (
		$witnesses, $placeNames, $persNames, $ref, $titles, $settlement, $region, $country, $active, $passive, $locus
	)
	return for $corr in $allrefs
		return $corr
};
	...
	return (: here I cannot use for the title the javascript titles.js because the content is not exposed :) <bibl>
		{
			let $ids := (
				$file//t:revisionDesc/t:change/@who |
					$file//t:fileDesc/t:titleStmt/t:editor[not(contains(@role, "generalEditor"))]/@key |
					$file//t:respStmt/@xml:id
			)
			let $cleanids :=
				for $i in distinct-values($ids)
				return replace($i, "#", "")
			for $author in distinct-values($cleanids)
			let $score := count($file//t:revisionDesc/t:change[@who eq $author]) +
				count($file//t:fileDesc/t:titleStmt/t:editor[@key eq $author]) +
				(
					if ($file//t:editor[@key eq $author][@role eq "cataloguer" or @role eq "editor"]) then
						100
					else
						0
				)
		...
		<date type="accessed"> [Accessed: { format-date(current-date(), "[Y0001]-[M01]-[D01]") }] </date>
		{
			...
			return <date type="lastModified">(Last Modified: { format-date($time, "[Y0001]-[M01]-[D01]") }) </date>
		}
		<idno type="url">{ ($config:appUrl || "/" || $collection || "/" || $id) }</idno>
	</bibl>
};
...
declare function apprest:bibdata($id, $this, $collection, $sha) as node()* {
	...
	return (: here I cannot use for the title the javascript titles.js because the content is not exposed :) <bibl>
		{
			let $ids := (
				$file//t:revisionDesc/t:change/@who | $file//t:fileDesc/t:titleStmt/t:editor/@key | $file//t:respStmt/@xml:id
			)
			let $cleanids :=
				for $i in distinct-values($ids)
				return replace($i, "#", "")
		...
		<idno type="url">{ ($config:appUrl || "/permanent/" || $sha || "/" || $collection || "/" || $id || "/main") }</idno>
	</bibl>
};
	...
	return <div class="w3-container">
		<div class="w3-row">
			<button
				...
				onclick="document.getElementById('cite').style.display='block'"
				style="vertical-align: top;width:300;"
			>Suggested citation</button>
			<button
				class="w3-button w3-grey"
				onclick="document.getElementById('revision').style.display='block'"
				style="vertical-align: top;width:300;"
			>Revision history</button>
			<button
				class="w3-button w3-grey"
				onclick="document.getElementById('att').style.display='block'"
				style="vertical-align: top;width:300;"
			>Attribution of the content</button>
			<button
				class="w3-button w3-grey"
				onclick="document.getElementById('perm').style.display='block'"
				style="vertical-align: top;width:300;"
			>Permalinks</button>
			<button
				class="w3-button w3-grey"
				onclick="document.getElementById('rdf').style.display='block'"
				style="vertical-align: top;width:300;"
			>RDF/VoID</button>
			<div class="w3-modal w3-card w3-margin" id="cite">
				<div class="w3-modal-content">
					<header class="w3-container w3-red">
						<span
							class="w3-button w3-display-topright"
							onclick="document.getElementById('cite').style.display='none'"
						>CLOSE</span>
					...
					<div class="w3-container" id="citationString">
						<p>
							{
								for $a in $app:bibdata//author/text()
								return ($a || ", ")
							} ʻ{ $app:bibdata//title[@level eq "a"]/text() }
							{
								if (contains($this//t:revisionDesc/t:change, "PEMM")) then
									" (originally prepared for The Princeton Ethiopian, Eritrean, and Egyptian Miracles of Mary (PEMM) project)"
								else (
								)
							}
							{
								if (
									$this//t:additional//t:source/t:listBibl[@type eq "catalogue"]/t:bibl/t:ptr[@target eq "bm:BmWebsite"]
								) then
									" (based on a historical catalogue and considerably enriched by the Bm team)"
								else if ($this//t:additional//t:source/t:listBibl[@type eq "catalogue"]) then
									" (encoded from the catalogue)"
								else (
								)
							}ʼ, in
<i>{ ($app:bibdata//title[@level eq "j"]/text() || " ") }</i>
							{ $app:bibdata//date[@type eq "lastModified"]/text() }
							<a href="{ $app:bibdata/idno/text() }">{ $app:bibdata/idno[@type eq "url"]/text() }</a>
							{ $app:bibdata//date[@type eq "accessed"]/text() }
						</p>
						<p>To cite a precise version, please, click on load permalinks and to the desired version (<a
								href="/pid.html"
							>see documentation on permalinks</a>), then import the metadata or copy the below, with the correct link.</p>
					</div>
				</div>
			</div>
			<div class="w3-modal w3-card w3-margin" id="revision">
				<div class="w3-modal-content">
					<header class="w3-container w3-red">
						<span
							class="w3-button w3-display-topright"
					...
					<ul>
						{
							...
							let $ES := if (contains($change/text(), "Ethio-SPaRe team photographed the manuscript")) then (
							) else if (xs:date($time) ge xs:date("2016-05-10")) then (
							) else if (not(starts-with($collection/text(), "Ethio-"))) then (
							) else
								" in Ethio-SPaRe "
							let $PEMM := if (contains($change/text(), "(PEMM")) then
								" for the PEMM project "
							else (
							)
							...
							return <li>
								{
									(
										if (contains($change/text(), "Ethio-SPaRe team photographed the manuscript")) then (
										) else
											<span property="http://purl.org/dc/elements/1.1/contributor">{ $author }</span>
									),
									(" " || $change/text() || $ES || $PEMM),
									(
										if (contains($change/text(), "(PEMM")) then (
										) else
			...
			<div class="w3-modal w3-card w3-margin" id="att">
				<div class="w3-modal-content">
					<header class="w3-container w3-red">
						<span
							class="w3-button w3-display-topright"
							onclick="document.getElementById('att').style.display='none'"
						>CLOSE</span>
					...
					<div>
						{
							...
							return if ($respStmt/t:persName) then (
								let $authors :=
									for $p in $respStmt/t:persName
									return (
										if ($p/@ref) then
											editors:editorKey(string($p/@ref))
										else
											$p
									) ||
										(
								...
								return <p>{ ($action || " by " || string-join($authors, ", ")) }</p>
							) else
								<p>{ $respStmt/t:name/text() || ", " || $respStmt/t:resp/text() }</p>
						}
					</div>
				</div>
			</div>
			<div class="w3-modal w3-card w3-margin" id="perm">
				<div class="w3-modal-content">
					<header class="w3-container w3-red">
						<span
							class="w3-button w3-display-topright"
							onclick="document.getElementById('perm').style.display='none'"
						>CLOSE</span>
						<h4>Permalinks</h4>
					</header>
					<div
   ...
   <a
		...
		</div>
		{
			if ($document//t:editionStmt/node()) then
				<div class="w3-panel w3-card-4 w3-padding w3-margin w3-red ">
		...
		{
			if ($document//t:availability/node()) then
				<div class="w3-panel w3-card-4 w3-padding w3-margin w3-white ">
...
declare function apprest:authors($this, $collection) {
	...
	let $id := string($this/@xml:id)
	let $app:bibdata := apprest:bibdata($id, $collection)
	return <div class="w3-container" id="citations" style="word-break:break-word;">
...
declare function apprest:authorsSHA($id, $this, $collection, $sha) {
	...
	return <div class="w3-container " id="citations">
		<div class="w3-third" id="citation">
			<div class="w3-panel w3-card-4 w3-padding w3-margin  w3-gray  w3-small">
				<h4>Suggested Citation of this record</h4>
				<div class="w3-container" id="citationString">
				...
				<div>
					{
						...
						return if ($respStmt/t:persName) then (
							...
							order by $action descending
							return <ul class="nodot">
								{
									for $task in $respStmt
									return <li class="nodot">{ $action || " by " || string-join($authors, ", ") }</li>
								}
							</ul>
						) else
							for $task in $respStmt
							return <li class="nodot">{ $respStmt/t:name/text() || ", " || $respStmt/t:resp/text() }</li>
					}
				</div>
			</div>
			{
...
(:~
 ...
 :)
declare %templates:default("start", 1) %templates:default("per-page", 20) function apprest:listrest(
	$type,
	$collection,
	$parameters as map(*),
	$params
	...
	let $allnames := if ($names = "") then (
	) else
		switch ($collection)
			case "manuscripts" return
				apprest:ListQueryParam-rest($names, "t:msIdentifier//t:idno", "any", "search")
			case "institutions" return
				apprest:ListQueryParam-rest($names, "t:place/t:placeName", "any", "search")
			case "places" return
				apprest:ListQueryParam-rest($names, "t:place/t:placeName", "any", "search")
			case "persons" return
				apprest:ListQueryParam-rest($names, "t:person/t:persName", "any", "search")
			case "works" return
				apprest:ListQueryParam-rest($names, "t:title", "any", "search")
			case "narratives" return
				apprest:ListQueryParam-rest($names, "t:title", "any", "search")
			default return
				()

	let $key := if ($keywords = "") then (
	) else
		switch ($collection)
			case "narratives" return
				()
			case "institutions" return
				apprest:ListQueryParam-rest($keywords, 't:ab[@type eq "tabot"]/t:persName/@ref', "any", "list")
			case "places" return
				apprest:ListQueryParam-rest($keywords, "t:place/@type", "any", "list")
			(: case 'persons' return apprest:ListQueryParam-rest($keywords, 't:occupation/@type', 'any', 'list') :)
			default return
				apprest:ListQueryParam-rest($keywords, "t:term/@key", "any", "list")

	let $ContentPr := if ($contentProvider = "") then (
	) else
	...
	let $CaeIDs := if ($CAeID = "") then (
	) else
		"[contains(@xml:id, '" || string(format-number($CAeID, "0000")) || "') and not(ends-with(@xml:id, 'IHA'))]"
	let $ClavisIDs := if (($clavisID = "") and ($clavisType = "")) then (
	) else if (($clavisID = "") and (matches($clavisType, "\w+"))) then
		"[descendant::t:bibl[@type eq '" || $clavisType || "']]"
	else
		"[descendant::t:bibl[@type eq '" || $clavisType || "'][t:citedRange eq '" || $clavisID || "']]"

	let $languages := if ($languages = "") then (
	) else
		apprest:ListQueryParam-rest($languages, "t:language/@ident", "any", "list")

	let $dR := if ($dateRange) then (
		let $range := $dateRange
		let $from := substring-before($dateRange, ",")
		let $to := substring-after($dateRange, ",")
		return if ($dateRange = "0,2000") then (
		) else
			"[descendant::t:origDate
                [xs:integer((if (contains(@notBefore, '-')) then (substring-before(@notBefore, '-')) else @notBefore)[. !='']) ge " ||
				$from ||
				" or
                xs:integer((if (contains(@notAfter, '-')) then    (substring-before(@notAfter, '-')) else    @notAfter)[. != '']) ge " ||
				$from ||
				"]
                [xs:integer((if (contains(@notBefore, '-')) then (substring-before(@notBefore, '-')) else @notBefore)[. !='']) le " ||
				$to ||
				" or
                xs:integer((if (contains(@notAfter, '-')) then (substring-before(@notAfter, '-')) else @notAfter)[. != '']) le " ||
				$to ||
				"]]"
	) else (
	)
	...
	let $material := if (empty($Pmaterial) or $Pmaterial = "") then (
	) else
		apprest:ListQueryParam-rest($Pmaterial, "t:support/t:material/@key", "any", "search")
	let $bmaterial := if (empty($Pbmaterial) or $Pbmaterial = "") then (
	) else
		apprest:ListQueryParam-rest($Pbmaterial, "t:decoNote[@type eq 'bindingMaterial']/t:material/@key", "any", "search")
	let $scripts := if (empty($Pscript) or $Pscript = "") then (
	) else
		apprest:ListQueryParam-rest($Pscript, "t:handNote/@script", "any", "search")
	let $scribes := if (empty($Pscribe) or $Pscribe = "") then (
	) else
		apprest:ListQueryParam-rest($Pscribe, "t:persName[@role eq 'scribe']/@ref", "any", "search")
	let $donors := if (empty($Pdonor) or $Pdonor = "") then (
	) else
		apprest:ListQueryParam-rest($Pdonor, "t:persName[@role eq 'donor']/@ref", "any", "search")
	let $patrons := if (empty($Ppatron) or $Ppatron = "") then (
	) else
		apprest:ListQueryParam-rest($Ppatron, "t:persName[@role eq 'patron']/@ref", "any", "search")
	let $owners := if (empty($Powner) or $Powner = "") then (
	) else
		apprest:ListQueryParam-rest($Powner, "t:persName[@role eq 'owner']/@ref", "any", "search")
	let $parchmentMakers := if (empty($PparchmentMaker) or $PparchmentMaker = "") then (
	) else
		apprest:ListQueryParam-rest($PparchmentMaker, "t:persName[@role eq 'parchmentMaker']/@ref", "any", "search")
	let $binders := if (empty($Pbinder) or $Pbinder = "") then (
	) else
		apprest:ListQueryParam-rest($Pbinder, "t:persName[@role eq 'binder']/@ref", "any", "search")
	let $contents := if (empty($Pcontent) or $Pcontent = "") then (
	) else
		apprest:ListQueryParam-rest($Pcontent, "t:title/@ref", "any", "search")
	let $tabots := if (empty($Ptabot) or $Ptabot = "") then (
	) else
		apprest:ListQueryParam-rest($Ptabot, "t:ab[@type eq 'tabot']//t:*/@*", "any", "search")
	let $placetypess := if (empty($Pplacetype) or $Pplacetype = "") then (
	) else
		apprest:ListQueryParam-rest($Pplacetype, "t:place/@type", "any", "search")
	let $Allauthors := if (empty($Pauthors) or $Pauthors = "") then (
	) else
		apprest:ListQueryParam-rest(
			$Pauthors,
			"t:relation[(@name eq 'saws:isAttributedToAuthor') or (@name eq 'dcterms:creator')]/@passive",
			"any",
			"search"
		)
	let $placetypess := if (empty($Pplacetype) or $Pplacetype = "") then (
		...
		apprest:ListQueryParam-rest($Pplacetype, "t:place/@type", "any", "search")
	let $occupations := if (empty($Poccupation) or $Poccupation = "") then (
	) else
		apprest:ListQueryParam-rest($Poccupation, "t:occupation/@type", "any", "search")
	let $faiths := if (empty($Pfaith) or $Pfaith = "") then (
	) else
		apprest:ListQueryParam-rest($Pfaith, "t:faith/@type", "any", "search")
	let $genders := if (empty($Pgender) or $Pgender = "") then (
	) else
		apprest:ListQueryParam-rest($Pgender, "t:person/@sex", "any", "list")
	let $periods := if (empty($Pperiod) or $Pperiod = "") then (
	) else
		apprest:ListQueryParam-rest($Pperiod, "t:term/@key", "any", "search")
	let $restorationss := if (empty($Prestorations) or $Prestorations = "") then (
	) else
		apprest:ListQueryParam-rest($Prestorations, "t:custEvent/@subtype", "any", "list")
	let $bindingtype := if (empty($Pbindingtype) or $Pbindingtype = "") then (
	) else
		apprest:ListQueryParam-rest($Pbindingtype, "t:binding/@contemporary", "any", "search")
	let $countries := if (empty($Pcountry) or $Pcountry = "") then (
	) else
		apprest:ListQueryParam-rest($Pcountry, "t:country/@ref", "any", "range")
	let $settlements := if (empty($Psettlement) or $Psettlement = "") then (
	) else
		apprest:ListQueryParam-rest($Psettlement, "t:settlement/@ref", "any", "range")

	let $leaves := if (empty($Pfolia) or $Pfolia = "") then (
	) else (
	...
	let $quiresComp := if (empty($Pqcn) or $Pqcn = "" or $Pqcn = "1,40") then (
		...
		return "[descendant::t:dim[ancestor::t:collation][@unit eq 'leaf'][not(.='')][. ge " ||
			$min ||
			" ][.  le " ||
			$max ||
			"]]"
	...
	let $path := switch ($type)
		case "catalogue" return
			...
			let $all := $apprest:collection-rootMS//t:listBibl[@type eq "catalogue"][descendant::t:ptr[@target eq
				$catal]]/ancestor::t:TEI
		...
		default return
			(
				if ($collection = "places") then (
					"$apprest:collection-rootPlIn//t:TEI" ||
						$countries ||
						$settlements ||
						$allnames ||
						$key ||
	...
	let $context := switch ($type)
		case "catalogue" return
			(
				'$apprest:collection-rootMS//t:listBibl[@type eq "catalogue"][descendant::t:ptr[@target eq "bm:' ||
					$collection ||
					'"]]/ancestor::t:TEI' ||
					$key ||
					$languages ||
		...
		case "repo" return
			(
				'$apprest:collection-rootMS//t:repository[@ref eq "' ||
					$collection ||
					'" ]/ancestor::t:TEI' ||
					$key ||
					$languages ||
	...
	let $hits :=
		...
		let $sorting := if (matches($recordid, "IHA")) then (
			"9" || substring($recordid, 4, 4)
		) else if (matches($recordid, "\w{3}\d+")) then
			substring($recordid, 4, 4)
		else
			substring($recordid, 0, 3)
		order by $sorting
		return $item
	(: let $test2 := console:log($context) :) return map {"hits": $hits, "collection": $collection, "query": $context}
};
...
declare function apprest:ListQueryParam-rest($parameter, $context, $mode, $function) {
	...
	return if ($function = "list") then
		let $all :=
			for $k in $keys
			return "descendant::" || $context || " eq '" || $k || "'"
		return "[" || string-join($all, " or ") || "]"
	else if ($function = "range") then
		let $all :=
			for $k in $keys
			return "descendant::" || $context || "[. = '" || $k || "']"
		return "[" || string-join($all, " or ") || "]"
	else
		(: search :)
		let $limit :=
			for $k in $parameter
			return "descendant::" || $context || "[ft:query(.,'" || $k || "')] "
...
declare function apprest:searchFilter-rest($collection, $model as map(*)) {
	...
	return <form
		action=""
		class="w3-container"
		data-hint="Any of these search filter implies that by searching a certain feature you do not only exclude those who have another value for that, but also all those items which do not carry the information at all."
	>
		<div class="w3-container">
			<label for="mainname">name</label>
			<input class="w3-input w3-border" id="mainname" name="mainname" />
		</div>
		...
		</div>
		{
			if ($items-info = <start />) then (
				...
				<div
					class="w3-container"
					data-hint="On a filtered search you will get for relevant values also the break down in numbers of items with that language"
				>
					<label for="language">languages </label>
					<select class="w3-select w3-border" id="language" multiple="multiple" name="language">
						{
							$evalContext/$app:range-lookup(
								"TEIlanguageIdent",
								"",
								function ($key, $count) {
									<option value="{ $key }">
										{ $apprest:languages//t:item[@xml:id eq $key]/text() } ({ $count[1] })</option>
								},
								1000
							)
						}
		...
		<div class="w3-container">
			...
			<select class="w3-select w3-border" name="cp">
			...
			switch ($collection)
				...
				case "works" return
					(
						<div class="w3-container" data-hint="Enter here the numeric identifier in Clavis Aethiopica">
							...
							<input class="w3-input w3-border" name="CAeID" type="number" />
						</div>,
						<div class="w3-container">
							<label>Other Clavis ID</label>
							<select class="w3-select w3-border" name="clavistype">
							...
							<input class="w3-input w3-border" name="clavisID" type="number" />
						</div>,
						if ($items-info = <start />) then (
							(: no selection done yet, provide index value :)
							<div
								class="w3-container"
								data-hint="On a filtered search you will get for relevant values also the break down in numbers of items with that keyword"
							>
								<label for="keyword">keywords </label>
								<select class="w3-select w3-border" id="keyword" multiple="multiple" name="keyword">
									{
										$evalContext/$app:range-lookup(
											"termkey",
											"",
											function ($key, $count) {
												<option value="{ $key }">{ exptit:printTitleID($key) } ({ $count[1] })</option>
											},
											1000
										)
									}
						...
						<div class="w3-container">
							<div
								class="w3-panel w3-red w3-leftbar"
								style="font-size: smaller;"
							>The period filter will search items which have the appropriate keyword assigned. It is equivalent to selecting that keyword. It is not equivalent to selecting a date range, because in that case we will search the dates, regardless of the attribution or not of one of the period keywords.</div>
							<label>periods</label>
				...
				case "places" return
					if ($items-info = <start />) then (
						...
						<div
							class="w3-container"
							data-hint="On a filtered search you will get for relevant values also the break down in numbers of items with that place type"
						>
							<label for="placetype">place type </label>
							<select class="w3-select w3-border" id="placetype" multiple="multiple" name="placetype">
								{
									$evalContext/$app:range-lookup(
										"placetype",
										"",
										function ($key, $count) {
											<option value="{ $key }">
												{
													if (matches($key, "\s")) then (
														let $titles :=
															for $k in tokenize($key, "\s")
															return exptit:printTitleID($k)
														return string-join($titles, ", ")
													) else
														exptit:printTitleID($key)
												} ({ $count[1] }) </option>
										},
										1000
									)
						...
						>
							...
							<select class="w3-select w3-border" id="country" multiple="multiple" name="country">
								{
									$evalContext/$app:range-lookup(
										"countryref",
										"",
						...
						>
							...
							<select class="w3-select w3-border" id="settlement" multiple="multiple" name="settlement">
								{
									$evalContext/$app:range-lookup(
										"settlref",
										"",
					...
					(
						if ($items-info = <start />) then (
							...
							<div class="w3-container">
								...
								<select class="w3-select w3-border" id="occupation" multiple="multiple" name="occupation">
									{
										$evalContext/$app:range-lookup(
											"occtype",
											"",
											function ($key, $count) { <option value="{ $key }">{ $key }</option> },
											1000
										)
									}
								</select>
							...
							<div class="w3-container">
								...
								<select class="w3-select w3-border" id="faith" multiple="multiple" name="faith">
									{
										$evalContext/$app:range-lookup(
											"faithtype",
											"",
							...
							<div class="w3-container">
								<input class="w3-check" name="gender" type="checkbox" value="1">Male</input>
								<input class="w3-check" name="gender" type="checkbox" value="2">Female</input>
							</div>
						)
					)
				...
				default return
					(
						...
						<div class="w3-container">
							...
							<input class="w3-input w3-border" id="numberOfP" name="numberOfParts" type="number" />
						</div>,
						<div class="w3-container w3-margin-left w3-margin-right">
							...
							<input
								...
								name="height"
								type="number" />
							<script type="text/javascript">{ "$('#heightslider').bootstrapSlider({});" }</script>
						</div>,
						<div class="w3-container w3-margin-left w3-margin-right">
							...
							<input
								...
								name="width"
								type="number" />
							<script type="text/javascript">{ "$('#widthslider').bootstrapSlider({});" }</script>
						</div>,
						<div class="w3-container w3-margin-left w3-margin-right">
							...
							<input
								...
								name="columnsNum"
								type="number" />
							<script type="text/javascript">{ "$('#NumberOfcolumns').bootstrapSlider({});" }</script>
						</div>,
						<div class="w3-container w3-margin-left w3-margin-right">
							...
							<input
								...
								name="tmargin"
								type="number" />
							<script type="text/javascript">{ "$('#tMslider').bootstrapSlider({});" }</script>
						</div>,
						<div class="w3-container w3-margin-left w3-margin-right">
							...
							<input
								...
								name="bmargin"
								type="number" />
							<script type="text/javascript">{ "$('#bMslider').bootstrapSlider({});" }</script>
						</div>,
						<div class="w3-container w3-margin-left w3-margin-right">
							...
							<input
								...
								name="rmargin"
								type="number" />
							<script type="text/javascript">{ "$('#rMslider').bootstrapSlider({});" }</script>
						</div>,
						<div class="w3-container w3-margin-left w3-margin-right">
							...
							<input
								...
								name="lmargin"
								type="number" />
							<script type="text/javascript">{ "$('#lMslider').bootstrapSlider({});" }</script>
						</div>,
						<div class="w3-container w3-margin-left w3-margin-right">
							...
							<input
								...
								data-slider-step="1"
								data-slider-value="[1,100]"
								id="lntercolumnslider"
								name="intercolumn"
								type="number" />
							<script type="text/javascript">{ "$('#lntercolumnslider').bootstrapSlider({});" }</script>
						</div>,
						<div class="w3-container w3-margin-left w3-margin-right">
							...
							<input
								...
								data-slider-value="[1.0,1000.0]"
								id="folia"
								name="folia"
								type="text" />
							<script type="text/javascript">{ "$('#folia').bootstrapSlider({});" }</script>
						</div>,
						<div class="w3-container w3-margin-left w3-margin-right">
							...
							<input
								...
								name="qn"
								type="text" />
							<script type="text/javascript">{ "$('#quires').bootstrapSlider({});" }</script>
						</div>,
						<div class="w3-container w3-margin-left w3-margin-right">
							...
							<input
								...
								name="qcn"
								type="text" />
							<script type="text/javascript">{ "$('#quiresComp').bootstrapSlider({});" }</script>
						</div>,
						<div class="w3-container w3-margin-left w3-margin-right">
							...
							<input
								...
								name="wL"
								type="text" />
							<script type="text/javascript">{ "$('#writtenLines').bootstrapSlider({});" }</script>
						</div>,
						<div class="w3-container w3-margin-left w3-margin-right">
							<label for="restorations">Restorations</label>
							<br />
							<select class="w3-select w3-border" id="restorations" name="restorations" type="text">
								<option value="">no selection</option>
							...
							<small
							>Only few manuscripts carry this information, selecting this filter you are searching only in those.</small>
						</div>,
						<div class="w3-container">
							<input
								class="w3-check"
								...
								type="checkbox"
								value="origPlace" /> place of origin<br />
							<input class="w3-check" data-context="{ $context }" type="checkbox" value="script" /> script<br />
							<input class="w3-check" data-context="{ $context }" type="checkbox" value="scribe" /> scribe<br />
							<input class="w3-check" data-context="{ $context }" type="checkbox" value="donor" /> donor<br />
							<input class="w3-check" data-context="{ $context }" type="checkbox" value="patron" /> patron<br />
							<input class="w3-check" data-context="{ $context }" type="checkbox" value="owner" /> owner<br />
							<input class="w3-check" data-context="{ $context }" type="checkbox" value="binder" /> binder<br />
							<input
								class="w3-check"
								data-context="{ $context }"
								type="checkbox"
								value="parchmentMaker" /> parchment maker<br />
							<input
								class="w3-check"
								data-context="{ $context }"
								type="checkbox"
								value="objectType" /> object type<br />
							<input class="w3-check" data-context="{ $context }" type="checkbox" value="material" /> material<br />
							<input
								class="w3-check"
								data-context="{ $context }"
								type="checkbox"
								value="bmaterial" /> binding material<br />
							<input
								class="w3-check"
								data-context="{ $context }"
								type="checkbox"
								value="bindingtype" /> original binding<br />
							{
								if ((count($items-info) lt 1050) and $items-info/node()) then (
									<input class="w3-check" data-context="{ $context }" type="checkbox" value="contents" />,
									"contents",
									<br />
								) else (
									<div
										class="w3-panel w3-red w3-leftbar"
									>You will be able to get a filter by contents for a selection of manuscripts with less than 1000 items.</div>
								)
							}
						</div>,
						<script src="resources/js/filtersRest.js" type="text/javascript" />,
...
(:~
 ...
 :)
declare function apprest:paginate-rest(
	$model as map(*),
	$parameters as map(*),
	$start as xs:int,
	$per-page as xs:int,
			...
			if ($min-hits < 0 or count($model("hits")) >= $min-hits) then
				...
				return (
					...
					return if ($i = ceiling($start div $per-page)) then
						<a
							class="w3-button"
							href="?per-page={ $per-page }&amp;start={ max((($i - 1) * $per-page + 1, 1)) }&amp;{ $params }"
						>{ $i }</a>
					else
						<a
							class="w3-button"
			...
			type="number" />
		{
			if ($model("type") = "text") then
				<a
					...
					href="?per-page={ count($model("hits")) }"
					id="fullText"
				>See full text</a>
			else (
			)
	...
	if ($group = "true") then (
		let $values :=
			...
			return if (contains($i, " ")) then
				...
				apprest:trim(normalize-space($i))
			...
			if ($type = "keywords") then (
				...
				return let $label := try {
					...
					return if (count($n) = 1) then
						<option value="{ $work }">{ exptit:printTitle($work) }</option>
					else (
				...
				return <option value="{ $institutionId }">{ exptit:printTitle($institutionId) }</option>
...
declare function apprest:compareMssFromForm($target-work as xs:string?) {
	...
	return if ($target-work = "") then (
		...
		let $ids :=
			...
			return string(root($manuscript)/t:TEI/@xml:id)
		return if (count($matchingmss) = 0) then (
			<p
				class="lead"
			>Oh no! Currently, none of the catalogued manuscripts contains a link to this work. You can still see the record in case you find there useful information.</p>,
			<a class="w3-button w3-red" href="{ $target-work }"> Go to { $MAINtit }</a>
		) else (
			<p class="w3-panel w3-card-2">There are currently <span class="w3-tag w3-gray">
					{ count($matchingmss) }
			...
			<div class=" w3-container" id="mscomps" style="overflow: auto; scroll-behavior: smooth;">
				{
					...
					let $notbefores :=
						for $nbef in root($manuscript)/t:TEI//@notBefore
						return number(substring($nbef, 1, 4))
					let $notafters :=
						for $naft in root($manuscript)/t:TEI//@notBefore
						return number(substring($naft, 1, 4))
					let $minnotBefore := min($notbefores)
					let $maxnotAfter := min($notafters)
					order by $minnotBefore
					return let $all := distinct-values($msid)
						for $one in $all
									...
									<ul class="nodot">
										{
											...
											return <li
												style="{
													if (matches($msitem/@xml:id, "\d+\.\d+\.\d+")) then
														"text-indent: 4%;"
													else if (matches($msitem/@xml:id, "\d+\.\d+")) then
														"text-indent: 2%;"
													else (
													)
												}"
											>
												...
												{
													if ($msitem/t:title/@type) then (
														" (" || string($msitem/t:title[1]/@type) || ")"
													) else (
													)
												},
{
													if ($title = $target-work) (: highlight the position of the currently selected work :) then
														<mark>
															<a class="itemtitle" data-value="{ $title }" href="{ $title }">{ $MAINtit }</a>
															{ $placement }
														</mark>
													(: if there is no ref, take the text of the element title content :)
													else if ($msitem/t:title[not(@ref)]/text()) then (
														...
														<span>
															<a class="itemtitle" data-value="{ $title }" href="{ $title }">
																{
																	if ($title = "") then
																		<span class="w3-tag w3-red">{ "no ref in title" }</span>
																	else
																		try { exptit:printTitle($title) } catch * { $title }
																}
															</a>
															{ $placement }
														</span>
									...
									<ul class="nodot">
										{
											for $additem at $p in
												root($manuscript)/t:TEI//t:additions//t:item[descendant::t:title[matches(@ref, $target-work)]]
											(: store in a variable the ref in the title or nothing :)
...
{
													for $t in $title
													return if ($t = $target-work) (: highlight the position of the currently selected work :) then
														<mark>
															<a class="itemtitle" data-value="{ $t }" href="{ $t }">{ $MAINtit }</a>
															{ $placement }
														</mark>
													(: if there is no ref, take the text of the element title content :)
													else if ($additem/t:title[not(@ref)]/text()) then (
														normalize-space(string-join(string:tei2string($additem/t:title/node()))), $placement
													) (: normally print the title of the referred item :) else (
														<span>
															<a class="itemtitle" data-value="{ $t }" href="{ $t }">
																{
																	if ($t = "") then
																		<span class="w3-tag w3-red">{ "no ref in title" }</span>
																	else
																		try { exptit:printTitle($t) } catch * { $t }
																}
															</a>
															{ $placement }
														</span>
...
declare function apprest:compareMssFromlist($mss) {
	if ($mss = "") then (
		...
		let $matchingmss :=
			for $ms in tokenize($mss, ",")
			return if (starts-with($ms, "LIT")) then (
				...
				$apprest:collection-rootMS//id($ms)[self::t:TEI]
		return (
							...
							<ul class="nodot">
								{
									...
									>
										...
										{
											if ($msitem/t:title[not(@ref)]/text()) then (
												normalize-space(string-join(string:tei2string($msitem/t:title/node()))), $placement
											) else (
												<a class="itemtitle" data-value="{ $title }" href="{ $title }">
													{
...
{
											for $t in $title
											return if ($additem/t:title[not(@ref)]/text()) then (
												normalize-space(string-join(string:tei2string($additem/t:title/node()))), $placement
											) (: normally print the title of the referred item :) else (
												<a class="itemtitle" data-value="{ $t }" href="{ $t }">
													{

...
declare %rest:GET %rest:path("/BetMasWeb/manuscripts/browse") %output:method("html5") function list:browseMS() {
	(
		<rest:response>
...
declare %rest:GET %rest:path("/BetMasWeb/Uni{$unitType}/browse") %output:method("html5") function list:browseUnits(
	$unitType
) {
	(
		<rest:response>
...
declare
	...
	%output:method("html5")
function list:artthemes($keyword as xs:string*) {
	<rest:response>
		<http:response status="200"><http:header name="Content-Type" value="text/html; charset=utf-8" /></http:response>
	</rest:response>,
	<html xmlns="http://www.w3.org/1999/xhtml">
													...
													if ($collection = "manuscripts") then (
														if (count($hits("hits")) lt 1050) then (
															<a
																...
																href="{ replace(substring-after(rest:uri(), "BetMas"), "list", "listChart") }?{
																	exreq:query()
																}"
																target="_blank"
															>Charts</a>
						...
						<div class="w3-panel w3-margin-bottom w3-card-4" id="listTopInfo">
							<div class="w3-bar">
								...
								<div id="optionsList">
									<a
										class="w3-bar-item w3-button w3-red"
										href="{ $config:appUrl }/{ replace(substring-after(rest:uri(), "BetMas"), "listChart", "list") }?{
											exreq:query()
										}"
										target="_blank"
									>List</a>
							...
							<div class="w3-panel w3-margin-bottom w3-card-4" id="listTopInfo">
								<div class="w3-bar">
									...
									<div id="optionsList">
										...
										<a
											class="w3-button w3-bar-item w3-red"
											href="{ replace(substring-after(rest:uri(), "BetMas"), "list", "listChart") }?{ exreq:query() }"
											role="button"
											target="_blank"
										>Charts</a>
										<a
						...
						<div class="w3-panel w3-margin-bottom w3-card-4" id="listTopInfo">
							<div class="w3-bar">
								...
								<div id="optionsList">
									<a
										class="w3-bar-item w3-button w3-red"
										href="{ replace(substring-after(rest:uri(), "BetMas"), "listChart", "list") }?{ exreq:query() }"
										target="_blank"
									>List</a>
								</div>
								<a
...
declare
	...
	%rest:query-param("place", "{$place}", "")
	%output:method("html5")
function list:getregionchart($place as xs:string*) {
	(: the file for that institution :)
	let $repos := $config:data-rootIn || "/"
...
declare %rest:GET %rest:path("/BetMasWeb/catalogues/list") %output:method("html5") function list:getcatalogues() {
	(

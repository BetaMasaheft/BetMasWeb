...
declare function restItem:ITEM($type, $id, $collection, $start, $end, $ref, $edition, $per-page, $hi as xs:string*) {
	...
	return if (xdb:collection-available($coll)) then (
		...
		if ($restItem:deleted//t:item[. eq $id]) then (
			let $formerlyListed := collection($config:data-root)//t:relation[@name = "betmas:formerlyAlsoListedAs" and
...
declare function restItem:mainContentGeobrowser($id as xs:string*) {
	<div class="w3-container">
...
declare function restItem:mainContentGraphManuscripts($this as element(), $id as xs:string*) {
...
declare function restItem:mainContentGraphPlaces($id as xs:string*) {
	<div class="w3-container">{ charts:pieAttestations($id, "placeName") }</div>
};

declare function restItem:mainContentGraphPersons($id as xs:string*) {
	<div class="w3-container">
		<div data-id="{ $id }" id="graph" />
...
declare function restItem:mainContentGraphAuthorityFiles($id as xs:string*) {
...
declare function restItem:mainContentGraphDefault($id as xs:string*, $collection as xs:string*) {
	<div class="w3-container">
...
declare function restItem:mainContentGraph($this as element(), $id as xs:string*, $collection as xs:string*) {
	switch ($collection)
		case "manuscripts" return
			restItem:mainContentGraphManuscripts($this, $id)
		case "places" return
			restItem:mainContentGraphPlaces($id)
		case "persons" return
			restItem:mainContentGraphPersons($id)
		case "authority-files" return
			restItem:mainContentGraphAuthorityFiles($id)
		default return
			restItem:mainContentGraphDefault($id, $collection)
};

declare function restItem:mainContentExtrasWorks($id as xs:string*) {
...
declare function restItem:mainContentExtras($this as element(), $id as xs:string*, $collection as xs:string*) {
	switch ($collection)
		case "works" return
			restItem:mainContentExtrasWorks($id)
		case "persons" return
...
declare function restItem:mainContent(
	...
	switch ($type)
		...
		case "geobrowser" return
			restItem:mainContentGeobrowser($id)
...
declare %private function restItem:processContains(
	$this as element(),
	$currentId as xs:string,
...
declare function restItem:capitalize-first($arg as xs:string?) as xs:string? {

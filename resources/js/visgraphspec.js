/**
 * Called from modules/scriptlinks.xqm scriptlinks:footerjsSelector()
 * 
 */

$(document).on({
    ajaxStart: function () { $("img#loading").show(); $("#BetMasRel").hide(); },
    ajaxStop: function () { $("img#loading").hide(); $("#BetMasRel").show(); }
});

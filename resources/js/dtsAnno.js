...
function updateindex(indexUrl) {
	...
	$.getJSON(api, function (d) {
		...
		var nav =
			'<div style="padding: 8px 8px;" class="w3-bar-item  indexNavigation" data-nav="' +
			d.view.first +
			'"><i class="fa fa-angle-double-left"></i></div><div style="padding: 8px 8px;"  class="w3-bar-item indexNavigation" data-nav="' +
			d.view.previous +
			'"><i class="fa fa-angle-left"></i></div><div style="padding: 8px 8px;"  class="w3-bar-item indexNavigation" data-nav="' +
			current +
			'">' +
			currentpage +
			"/" +
			totalpages +
			'</div><div style="padding: 8px 8px;"  class="w3-bar-item  indexNavigation" data-nav="' +
			d.view.next +
			'"><i class="fa fa-angle-right"></i></div><div style="padding: 8px 8px;"  class="w3-bar-item  indexNavigation" data-nav="' +
			last +
    ...
    " data-source=" ' +
		...
		var closebutton = '<div class="w3-bar-item w3-gray w3-small CloseIndex">Close</div>';

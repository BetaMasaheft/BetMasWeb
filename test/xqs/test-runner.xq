...
import module namespace tsdtsregex = "https://www.betamasaheft.uni-hamburg.de/BetMasWeb/ts-dtslib-regexid" at "ts-dtslib-regexid.xqm";
...
import module namespace tsexpshards = "https://www.betamasaheft.uni-hamburg.de/BetMasWeb/ts-expand-shards" at "ts-expand-shards.xqm";
...
import module namespace tsrangeidx = "https://www.betamasaheft.uni-hamburg.de/BetMasWeb/ts-queries-rangeindex" at "ts-queries-rangeindex.xqm";
...
test:suite(
	(
		...
		inspect:module-functions(xs:anyURI("ts-dtslib-regexid.xqm")),
		...
		inspect:module-functions(xs:anyURI("ts-expand-shards.xqm")),
		...
		inspect:module-functions(xs:anyURI("ts-queries-rangeindex.xqm")),

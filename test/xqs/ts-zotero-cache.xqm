...
declare %test:assertXPath("map:contains($result, 'editionHtml')") function tszc:enrich-bm-adds-edition-html() {
	zc:enrich-versions(
		map {
			"total": 1,
			"versions":
...
declare %test:assertXPath("contains($result, 'Title')") function tszc:serialize-html-keeps-markup() {
	zc:html-string(<div class="csl-entry"><i>Title</i></div>)
};

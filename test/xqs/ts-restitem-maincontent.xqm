...
(:~
 ...
 : - into named functions (restItem:mainContentCorpus, ...Geobrowser,
 : ...Analytic, ...Text, ...Graph, ...Default) behind a thin
 : restItem:mainContent(...) dispatcher. The "graph" and default ("THE
 : MAIN VIEW") cases each had their own nested switch($collection), split
 : the same way (restItem:mainContentGraph* / restItem:mainContentExtras*).
 ...
 :
 : Skips the "graph" case for manuscripts - restItem:mainContentGraphManuscripts
...
declare %test:assertTrue function tsmaincontent:dispatch-matches-direct-call-geobrowser() {
	deep-equal(
		...
		restItem:mainContentGeobrowser("LOC3080Ferheb")
	)
};
...
declare %test:assertTrue function tsmaincontent:graph-dispatch-matches-direct-call-places() {
	...
	return deep-equal(
		restItem:mainContentGraph($this, "LOC3080Ferheb", "places"),
		restItem:mainContentGraphPlaces("LOC3080Ferheb")
	)
};
...
declare %test:assertTrue function tsmaincontent:graph-dispatch-matches-direct-call-persons() {
	...
	return deep-equal(
		...
		restItem:mainContentGraphPersons("PRS8278SablaWa")
	)
};
...
declare %test:assertTrue function tsmaincontent:graph-dispatch-matches-direct-call-authority-files() {
	...
	return deep-equal(
		...
		restItem:mainContentGraphAuthorityFiles("AT1129MMFrank")
	)
};
...
declare %test:assertTrue function tsmaincontent:graph-dispatch-matches-direct-call-default() {
	...
	return deep-equal(
		...
		restItem:mainContentGraphDefault("corpus2", "corpora")
	)
};
...
declare %test:assertTrue function tsmaincontent:extras-dispatch-matches-direct-call-works() {
	...
	return deep-equal(
		...
		restItem:mainContentExtrasWorks("LIT3508Epistle")
	)
};
